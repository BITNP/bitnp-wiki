...
title: 面试系统
path: interview
description: https://interview.bitnp.net/interview
contentType: markdown
---

# [面试系统](https://interview.bitnp.net/)

## 一些链接

- 部署位置：[interview.bitnp.net](https://interview.bitnp.net/)
- 面试模块：[/interview/](https://interview.bitnp.net/interview/)
- 录取模块：[/admission/](https://interview.bitnp.net/admission/)
- 候场教室公开看板（可以投屏大屏幕）：[/interview/public](https://interview.bitnp.net/interview/public)
- 管理员后台：[/admin/](https://interview.bitnp.net/admin/)
...
加载数据使用django的fixtures功能，示例数据见[仓库中路径
`interview/fixtures/init_data.json`](https://git.bitnp.net/BITNP/interview_django/-/blob/master/interview/fixtures/init_data.json)。
...
位置：[/admin/auth/user/](https://interview.bitnp.net/admin/auth/user/)
...
位置：[/admission/admission_start](https://interview.bitnp.net/admission/admission_start)
