...
|:-----:|:-----:|:-----:|:-----:|:-----:|:------:|
[软件模块](#software)|[安装软件](#installSoft)|[清理文件](#clearFiles)|[安装系统](#installOS)|[配置环境](#envConfig)|...
[硬件模块](#hardware)|[清灰](#clearDust)|[安装硬盘](#installHarddisk)|[换硅脂](#changeAbaAba)|[换风扇](#changeFan)|...
[网络模块](#network)|...|...|...|...|...
[蓝屏模块](#blueScreen)|...|...|...|...|...
[黑屏模块](#blackScreen)|...|...|...|...|...
...
|:----:|:----:|:----:|:----:|:----:|
|VsCode| [C/C++ 编译环境配置](https://blog.csdn.net/wohu1104/article/details/111464778)|...|...|...|
|Python| Anaconda环境配置与虚拟环境使用(为什么不用docker:blush:)|...|...|...|
|Java| JVM开发工具配置|...|...|...|
|VmWare| 虚拟机安装与版本选择|...|...|...|
|...|...|...|...|...|
